...
// source: vqro.proto
#ifndef GRPC_vqro_2eproto__INCLUDED
#define GRPC_vqro_2eproto__INCLUDED
 ...
 public:
  class StubInterface {
   public:
    ...
    std::unique_ptr< ::grpc::ClientReaderInterface< ::vqro::rpc::SearchSeriesResult>> SearchSeries(::grpc::ClientContext* context, const ::vqro::rpc::SeriesQuery& request) {
      return std::unique_ptr< ::grpc::ClientReaderInterface< ::vqro::rpc::SearchSeriesResult>>(SearchSeriesRaw(context, request));
    }
    std::unique_ptr< ::grpc::ClientAsyncReaderInterface< ::vqro::rpc::SearchSeriesResult>> AsyncSearchSeries(::grpc::ClientContext* context, const ::vqro::rpc::SeriesQuery& request, ::grpc::CompletionQueue* cq, void* tag) {
      return std::unique_ptr< ::grpc::ClientAsyncReaderInterface< ::vqro::rpc::SearchSeriesResult>>(AsyncSearchSeriesRaw(context, request, cq, tag));
    }
    std::unique_ptr< ::grpc::ClientReaderInterface< ::vqro::rpc::SearchLabelsResult>> SearchLabels(::grpc::ClientContext* context, const ::vqro::rpc::LabelsQuery& request) {
      return std::unique_ptr< ::grpc::ClientReaderInterface< ::vqro::rpc::SearchLabelsResult>>(SearchLabelsRaw(context, request));
    }
    std::unique_ptr< ::grpc::ClientAsyncReaderInterface< ::vqro::rpc::SearchLabelsResult>> AsyncSearchLabels(::grpc::ClientContext* context, const ::vqro::rpc::LabelsQuery& request, ::grpc::CompletionQueue* cq, void* tag) {
      return std::unique_ptr< ::grpc::ClientAsyncReaderInterface< ::vqro::rpc::SearchLabelsResult>>(AsyncSearchLabelsRaw(context, request, cq, tag));
    }
  private:
    ...
    virtual ::grpc::ClientReaderInterface< ::vqro::rpc::SearchSeriesResult>* SearchSeriesRaw(::grpc::ClientContext* context, const ::vqro::rpc::SeriesQuery& request) = 0;
    virtual ::grpc::ClientAsyncReaderInterface< ::vqro::rpc::SearchSeriesResult>* AsyncSearchSeriesRaw(::grpc::ClientContext* context, const ::vqro::rpc::SeriesQuery& request, ::grpc::CompletionQueue* cq, void* tag) = 0;
    virtual ::grpc::ClientReaderInterface< ::vqro::rpc::SearchLabelsResult>* SearchLabelsRaw(::grpc::ClientContext* context, const ::vqro::rpc::LabelsQuery& request) = 0;
    virtual ::grpc::ClientAsyncReaderInterface< ::vqro::rpc::SearchLabelsResult>* AsyncSearchLabelsRaw(::grpc::ClientContext* context, const ::vqro::rpc::LabelsQuery& request, ::grpc::CompletionQueue* cq, void* tag) = 0;
  };
  class Stub GRPC_FINAL : public StubInterface {
   public:
    ...
    std::unique_ptr< ::grpc::ClientReader< ::vqro::rpc::SearchSeriesResult>> SearchSeries(::grpc::ClientContext* context, const ::vqro::rpc::SeriesQuery& request) {
      return std::unique_ptr< ::grpc::ClientReader< ::vqro::rpc::SearchSeriesResult>>(SearchSeriesRaw(context, request));
    }
    std::unique_ptr< ::grpc::ClientAsyncReader< ::vqro::rpc::SearchSeriesResult>> AsyncSearchSeries(::grpc::ClientContext* context, const ::vqro::rpc::SeriesQuery& request, ::grpc::CompletionQueue* cq, void* tag) {
      return std::unique_ptr< ::grpc::ClientAsyncReader< ::vqro::rpc::SearchSeriesResult>>(AsyncSearchSeriesRaw(context, request, cq, tag));
    }
    std::unique_ptr< ::grpc::ClientReader< ::vqro::rpc::SearchLabelsResult>> SearchLabels(::grpc::ClientContext* context, const ::vqro::rpc::LabelsQuery& request) {
      return std::unique_ptr< ::grpc::ClientReader< ::vqro::rpc::SearchLabelsResult>>(SearchLabelsRaw(context, request));
    }
    std::unique_ptr< ::grpc::ClientAsyncReader< ::vqro::rpc::SearchLabelsResult>> AsyncSearchLabels(::grpc::ClientContext* context, const ::vqro::rpc::LabelsQuery& request, ::grpc::CompletionQueue* cq, void* tag) {
      return std::unique_ptr< ::grpc::ClientAsyncReader< ::vqro::rpc::SearchLabelsResult>>(AsyncSearchLabelsRaw(context, request, cq, tag));
    }
   ...
   private:
    ...
    ::grpc::ClientReader< ::vqro::rpc::SearchSeriesResult>* SearchSeriesRaw(::grpc::ClientContext* context, const ::vqro::rpc::SeriesQuery& request) GRPC_OVERRIDE;
    ::grpc::ClientAsyncReader< ::vqro::rpc::SearchSeriesResult>* AsyncSearchSeriesRaw(::grpc::ClientContext* context, const ::vqro::rpc::SeriesQuery& request, ::grpc::CompletionQueue* cq, void* tag) GRPC_OVERRIDE;
    ::grpc::ClientReader< ::vqro::rpc::SearchLabelsResult>* SearchLabelsRaw(::grpc::ClientContext* context, const ::vqro::rpc::LabelsQuery& request) GRPC_OVERRIDE;
    ::grpc::ClientAsyncReader< ::vqro::rpc::SearchLabelsResult>* AsyncSearchLabelsRaw(::grpc::ClientContext* context, const ::vqro::rpc::LabelsQuery& request, ::grpc::CompletionQueue* cq, void* tag) GRPC_OVERRIDE;
  ...
  class Service : public ::grpc::SynchronousService {
   public:
    ...
    virtual ::grpc::Status SearchSeries(::grpc::ServerContext* context, const ::vqro::rpc::SeriesQuery* request, ::grpc::ServerWriter< ::vqro::rpc::SearchSeriesResult>* writer);
    virtual ::grpc::Status SearchLabels(::grpc::ServerContext* context, const ::vqro::rpc::LabelsQuery* request, ::grpc::ServerWriter< ::vqro::rpc::SearchLabelsResult>* writer);
  ...
  class AsyncService GRPC_FINAL : public ::grpc::AsynchronousService {
   public:
    ...
    void RequestSearchSeries(::grpc::ServerContext* context, ::vqro::rpc::SeriesQuery* request, ::grpc::ServerAsyncWriter< ::vqro::rpc::SearchSeriesResult>* writer, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag);
    void RequestSearchLabels(::grpc::ServerContext* context, ::vqro::rpc::LabelsQuery* request, ::grpc::ServerAsyncWriter< ::vqro::rpc::SearchLabelsResult>* writer, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag);
  };
};
...
#endif  // GRPC_vqro_2eproto__INCLUDED
